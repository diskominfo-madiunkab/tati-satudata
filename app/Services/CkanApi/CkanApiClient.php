...
namespace App\Services\CkanApi;

use App\Services\CkanApi\Exceptions\MethodNotImplementedException;
use App\Services\CkanApi\Factories\RepositoryFactory;
use Exception;
...
class CkanApiClient
{
    ...
    {
        $className = 'App\\Services\\CkanApi\Repositories\\' . ucwords($method) . 'Repository';
