                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="konsep"
                                ...
                                disabled>{{old('konsep', optional($data->variabel)->konsep ?? optional($data->standar)->konsep)}}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea id="definisi" name="definisi" type="text"
                                ...
                                disabled>{{old('definisi', optional($data->variabel)->definisi ?? optional($data->standar)->definisi)}}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea id="interpretasi" name="interpretasi" type="text"
                                ...
                                style="height: 100px" spellcheck="false" placeholder="Interpretasi"
                                disabled>{{old('interpretasi', optional($data->indikator)->interpretasi)}}</textarea>
                        ...
                        <div class="row col-sm-10">
                            ...
                            <div class="col-sm-{{$isImage ? 4 : 8}}">
                                <textarea name="metode" id="metode"
                                    ...
                                    style="height: 100px" spellcheck="false" placeholder="Metode / Rumus Perhitungan"
                                    disabled>{{optional($data->indikator)->metode}}</textarea>
                            </div>
                            @if ($isImage)
                            <div class="col-sm-4">
                                <img class="img-fluid rounded" height="250px"
                                    style="{{ isset($metode) ? ($metode->accepted) ? 'border:5px solid green' : 'border:5px solid red' : '' }}"
                                    width="250px" src="{{Storage::url(optional($data->indikator)->metode)}}">
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="klasifikasi_penyajian"
                                ...
                                disabled>{{old('klasifikasi_penyajian', optional($data->indikator)->klasifikasi_penyajian)}}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-check">
                                ...
                                optional($data->indikator)->komposit)) ? 'checked' : ''}} disabled>
                    ...
                    <section class="komposit-section">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <p class="text-muted text-comment">Komentar: {{$publikasi_indikator_pembangun->comment}}
                                </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="nama_indikator_pembangun"
                                    ...
                                    style="height: 100px" spellcheck="false" placeholder="Nama Indikator Pembangun"
                                    disabled>{{old('nama_indikator_pembangun', optional($data->indikator)->nama_indikator_pembangun)}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="nama_variabel_pembangun"
                                    ...
                                    style="height: 100px" spellcheck="false" placeholder="Nama Variabel Pembangun"
                                    disabled>{{old('nama_variabel_pembangun', optional($data->indikator)->nama_variabel_pembangun)}}</textarea>
                        ...
                        <div class="col-sm-10">
                            <select
                                ...
                                <option value="nasional" {{old('level_estimasi', optional($data->
                                    ...
                                    optional($data->indikator)->level_estimasi)) ? 'selected' : ''}}>Nasional</option>
                                ...
                                <option value="kecamatan" {{old('level_estimasi', optional($data->
                                    indikator)->level_estimasi) == 'kecamatan' ? 'selected' : ''}}>Kecamatan</option>
                                <option value="kelurahan" {{old('level_estimasi', optional($data->
                                    indikator)->level_estimasi) == 'kelurahan' ? 'selected' : ''}}>Desa/Kelurahan
                                </option>
                                <option value="rt" {{old('level_estimasi', optional($data->indikator)->level_estimasi)
                                    == 'rt' ? 'selected' : ''}}>Rumah Tangga</option>
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-check">
                                <input
                                    ...
                                    optional($data->indikator)->umum) == 0 ? 'checked' : ''}} disabled>
