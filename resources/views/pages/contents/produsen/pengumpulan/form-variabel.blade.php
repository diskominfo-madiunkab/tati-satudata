...
$variables = ['nama', 'alias', 'definisi', 'konsep', 'referensi_pemilihan', 'referensi_waktu', 'tipe_data',
'klasifikasi_isian', 'ukuran', 'satuan', 'aturan_validasi', 'kalimat_pertanyaan', 'umum'];
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="nama" name="nama" type="text"
                                    ...
                                    placeholder="Nama Variabel" value="{{old('nama', $getdata->nama_data)}}" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="alias" name="alias" type="text"
                                    ...
                                    placeholder="Alias" value="{{old('alias', optional($getdata->variabel)->alias)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="konsep" readonly
                                    ...
                                    placeholder="Konsep">{{old('konsep', optional($getdata->variabel)->konsep ?? optional($getdata->standar)->konsep)}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select
                                    ...
                                    <option value="integer" {{old('tipe_data', optional($getdata->variabel)->tipe_data)
                                        ==
                                        'integer' || empty(optional($getdata->variabel)->tipe_data) ? 'selected' :
                                        ''}}>Integer</option>
                                    <option value="float" {{old('tipe_data', optional($getdata->variabel)->tipe_data) ==
                                        'float' ? 'selected' : ''}}>Float</option>
                                    <option value="char" {{old('tipe_data', optional($getdata->variabel)->tipe_data) ==
                                        'char' ? 'selected' : ''}}>Char</option>
                                    <option value="string" {{old('tipe_data', optional($getdata->variabel)->tipe_data)
                                        ==
                                        'string' ? 'selected' : ''}}>String</option>
                                    <option value="array" {{old('tipe_data', optional($getdata->variabel)->tipe_data) ==
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="klasifikasi_isian" readonly
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Klasifikasi Isian">{{old('klasifikasi_isian', optional($getdata->variabel)->klasifikasi_isian ?? optional($getdata->standar)->klasifikasi)}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="aturan_validasi"
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Aturan Validasi">{{old('aturan_validasi', optional($getdata->variabel)->aturan_validasi)}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="kalimat_pertanyaan"
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Kalimat Pertanyaan">{{old('kalimat_pertanyaan', optional($getdata->variabel)->kalimat_pertanyaan)}}</textarea>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        ...
                                        optional($getdata->variabel)->umum) == 1 || empty(old('umum',
                                    optional($getdata->variabel)->umum)) ? 'checked' : ''}}>
                                ...
                                <div class="form-check">
                                    <input
                                        ...
                                        optional($getdata->variabel)->umum) == 0 ? 'checked' : ''}}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="konsep" readonly
                                    class="form-control {{ isset($konsep) ? ($konsep->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Konsep">{{old('konsep', optional($data->variabel)->konsep ?? optional($data->standar)->konsep)}}</textarea>
                                @if (isset($konsep) && !empty($konsep->comment))
                                <p class="text-muted text-comment">Komentar: {{$konsep->comment}}</p>
                                @endif
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="klasifikasi_isian" readonly
                                    class="form-control {{ isset($klasifikasi_isian) ? ($klasifikasi_isian->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Klasifikasi Isian">{{old('klasifikasi_isian', optional($data->variabel)->klasifikasi_isian ?? optional($data->standar)->klasifikasi)}}</textarea>
                                @if (isset($klasifikasi_isian) && !empty($klasifikasi_isian->comment))
                                <p class="text-muted text-comment">Komentar: {{$klasifikasi_isian->comment}}</p>
                                @endif
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="aturan_validasi"
                                    class="form-control {{ isset($aturan_validasi) ? ($aturan_validasi->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Aturan Validasi">{{old('aturan_validasi', optional($data->variabel)->aturan_validasi)}}</textarea>
                                @if (isset($aturan_validasi) && !empty($aturan_validasi->comment))
                                <p class="text-muted text-comment">Komentar: {{$aturan_validasi->comment}}</p>
                                @endif
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="kalimat_pertanyaan"
                                    class="form-control {{ isset($kalimat_pertanyaan) ? ($kalimat_pertanyaan->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Kalimat Pertanyaan">{{old('kalimat_pertanyaan', optional($data->variabel)->kalimat_pertanyaan)}}</textarea>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($umum) ? ($umum->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="umum" id="umum1" value="1" {{old('umum',
                                        optional($data->variabel)->umum) == 1 ||
                                    empty(old('umum',
                                    optional($data->variabel)->umum)) ? 'checked' : ''}}>
                                    <label class="form-check-label" for="umum1">
                                        Ya
                                    </label>
                                </div>
