...
$variables = ['nama', 'alias', 'definisi', 'interpretasi', 'konsep', 'metode', 'ukuran', 'satuan',
'klasifikasi_penyajian', 'komposit', 'publikasi_indikator_pembangun', 'nama_indikator_pembangun',
'kegiatan_variabel_pembangun', 'kode_kegiatan_variabel_pembangun', 'nama_variabel_pembangun', 'level_estimasi', 'umum'];
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('simpan-indikator', $data->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="nama" name="nama" type="text"
                                    ...
                                    placeholder="Nama Indikator" value="{{old('nama', $getdata->nama_data)}}" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="konsep" name="konsep" type="text" readonly
                                    ...
                                    placeholder="Konsep" value="{{old('konsep', optional($data->standar)->konsep)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="definisi" readonly
                                    ...
                                    placeholder="Definisi">{{old('definisi', optional($data->standar)->definisi) }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="interpretasi" name="interpretasi" type="text"
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Interpretasi">{{old('interpretasi', optional($getdata->indikator)->interpretasi)}}</textarea>
                        ...
                        @php
                        $isImage = optional($getdata->indikator)->metode &&
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="ukuran" name="ukuran" type="text" readonly
                                    ...
                                    placeholder="Ukuran" value="{{old('ukuran', optional($data->standar)->ukuran)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input id="satuan" name="satuan" type="text" readonly
                                    ...
                                    placeholder="Satuan" value="{{old('satuan', optional($data->standar)->satuan)}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="klasifikasi_penyajian" readonly
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Klasifikasi Penyajian">{{old('klasifikasi_penyajian', optional($data->standar)->klasifikasi)}}</textarea>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        ...
                                        type="radio" name="komposit" id="komposit1" value="1" {{old('komposit',
                                        optional($getdata->indikator)->komposit) == 1 ? 'checked' : ''}}>
                                    <label class="form-check-label" for="gridRadios1"> Ya </label>
                                </div>
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($komposit) ? ($komposit->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="komposit" id="komposit2" value="0" {{old('komposit',
                                        optional($getdata->indikator)->komposit) == 0 || empty(old('komposit',
                                    optional($getdata->indikator)->komposit)) ? 'checked' : ''}}>
                        ...
                        <section class="komposit-section">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if (isset($publikasi_indikator_pembangun) &&
                                    !empty($publikasi_indikator_pembangun->comment))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="nama_indikator_pembangun"
                                        ...
                                        style="height: 100px" spellcheck="false"
                                        placeholder="Nama Indikator Pembangun">{{old('nama_indikator_pembangun', optional($getdata->indikator)->nama_indikator_pembangun)}}</textarea>

                                    @if (isset($nama_indikator_pembangun) && !empty($nama_indikator_pembangun->comment))
                                    <p class="text-muted text-comment">Komentar: {{$nama_indikator_pembangun->comment}}
                                    </p>
                                    <hr>
                                    @endif
                        ...
                        <section class="no-komposit-section">
                            {{-- <div class="row mb-3">--}}
                                ...
                                {{-- <div class="col-sm-10">--}}
                                    ...
                                    {{-- @if (isset($kode_kegiatan_vaariabel_pembangun) &&
                                    !empty($kode_kegiatan_vaariabel_pembangun->comment))--}}
                                    {{-- <p class="text-muted text-comment">Komentar:
                            ...
                            {{-- <div class="row mb-3">--}}
                                ...
                                {{-- <div class="col-sm-10">--}}
                                    ...
                                    {{-- @if (isset($kegiatan_variabel_pembangun) &&
                                    !empty($kegiatan_variabel_pembangun->comment))--}}
                                    {{-- <p class="text-muted text-comment">Komentar:
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="nama_variabel_pembangun"
                                        ...
                                        style="height: 100px" spellcheck="false"
                                        placeholder="Nama Variabel Pembangun">{{old('nama_variabel_pembangun', optional($getdata->indikator)->nama_variabel_pembangun)}}</textarea>

                                    @if (isset($nama_variabel_pembangun) && !empty($nama_variabel_pembangun->comment))
                                    <p class="text-muted text-comment">Komentar: {{$nama_variabel_pembangun->comment}}
                                    </p>
                                    <hr>
                                    @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select
                                    ...
                                    <option value="nasional" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'nasional'
                                        || empty(old('level_estimasi', optional($getdata->indikator)->level_estimasi)) ?
                                        'selected' : ''}}>Nasional
                                    </option>
                                    <option value="provinsi" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'provinsi' ?
                                        'selected' : ''}}>Provinsi</option>
                                    <option value="kabupaten" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'kabupaten'
                                        ? 'selected' : ''}}>Kabupaten/kota</option>
                                    <option value="perangkat_daerah" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) ==
                                        'perangkat_daerah' ? 'selected' : ''}}>Perangkat Daerah</option>
                                    <option value="kecamatan" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'kecamatan'
                                        ? 'selected' : ''}}>Kecamatan</option>
                                    <option value="kelurahan" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'kelurahan'
                                        ? 'selected' : ''}}>Desa/Kelurahan</option>
                                    <option value="rt" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'rt' ? 'selected'
                                        : ''}}>Rumah Tangga</option>
                                    <option value="individu" {{old('level_estimasi', optional($getdata->
                                        indikator)->level_estimasi) == 'individu' ?
                                        'selected' : ''}}>Individu</option>
                                </select>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        ...
                                        type="radio" name="umum" id="umum1" value="1" {{old('umum',
                                        optional($getdata->indikator)->umum) == 1 ||
                                    empty(old('umum', optional($getdata->indikator)->umum)) ? 'checked' : ''}}>
                                ...
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($umum) ? ($umum->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="umum" id="umum2" value="0" {{old('umum',
                                        optional($getdata->indikator)->umum) == 0 ?
                                    'checked' : ''}}>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="interpretasi" name="interpretasi" type="text"
                                    class="form-control {{ isset($interpretasi) ? ($interpretasi->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Interpretasi">{{old('interpretasi', optional($data->indikator)->interpretasi)}}</textarea>
                                @if (isset($interpretasi) && !empty($interpretasi->comment))
                                <p class="text-muted text-comment">Komentar: {{$interpretasi->comment}}</p>
                                @endif
                            </div>
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($komposit) ? ($komposit->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="komposit" id="komposit1" value="1" {{old('komposit',
                                        optional($data->indikator)->komposit) == 1 ? 'checked' : ''}}>
                                    <label class="form-check-label" for="gridRadios1"> Ya </label>
                                </div>
                                <div class="form-check">
                                    <input
                                    ...
                                    optional($data->indikator)->komposit)) ? 'checked' : ''}}>
                                    <label class="form-check-label" for="gridRadios1"> Tidak </label>
                                </div>
                                @if (isset($komposit) && !empty($komposit->comment))
                                <p class="text-muted text-comment">Komentar: {{$komposit->comment}}</p>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="nama_indikator_pembangun"
                                        class="form-control {{ isset($nama_indikator_pembangun) ? ($nama_indikator_pembangun->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        style="height: 100px" spellcheck="false"
                                        placeholder="Nama Indikator Pembangun">{{old('nama_indikator_pembangun', optional($data->indikator)->nama_indikator_pembangun)}}</textarea>
                                    @if (isset($nama_indikator_pembangun) && !empty($nama_indikator_pembangun->comment))
                                    <p class="text-muted text-comment">Komentar: {{$nama_indikator_pembangun->comment}}
                                    </p>
                                    <hr>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="nama_variabel_pembangun"
                                        class="form-control {{ isset($nama_variabel_pembangun) ? ($nama_variabel_pembangun->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        style="height: 100px" spellcheck="false"
                                        placeholder="Nama Variabel Pembangun">{{old('nama_variabel_pembangun', optional($data->indikator)->nama_variabel_pembangun)}}</textarea>
                                    @if (isset($nama_variabel_pembangun) && !empty($nama_variabel_pembangun->comment))
                                    <p class="text-muted text-comment">Komentar: {{$nama_variabel_pembangun->comment}}
                                    </p>
                                    <hr>
                            ...
                            <div class="col-sm-10">
                                <select
                                    ...
                                    <option value="provinsi" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'provinsi' ? 'selected' : ''}}>Provinsi</option>
                                    <option value="kabupaten" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'kabupaten' ? 'selected' : ''}}>Kabupaten/kota
                                    </option>
                                    <option value="perangkat_daerah" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'perangkat_daerah' ? 'selected' : ''}}>Perangkat
                                        Daerah</option>
                                    ...
                                    <option value="kelurahan" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'kelurahan' ? 'selected' : ''}}>Desa/Kelurahan
                                    </option>
                                    <option value="rt" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'rt' ? 'selected' : ''}}>Rumah Tangga</option>
                                    <option value="individu" {{old('level_estimasi', optional($data->
                                        indikator)->level_estimasi) == 'individu' ? 'selected' : ''}}>Individu</option>
                                </select>
                                @if (isset($level_estimasi) && !empty($level_estimasi->comment))
                                <p class="text-muted text-comment">Komentar: {{$level_estimasi->comment}}</p>
                                @endif
                            ...
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($umum) ? ($umum->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="umum" id="umum1" value="1" {{old('umum',
                                        optional($data->indikator)->umum) == 1 || empty(old('umum',
                                    optional($data->indikator)->umum)) ? 'checked' : ''}}>
                                    <label class="form-check-label" for="umum1">
                                        Ya
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input
                                        class="form-check-input {{ isset($umum) ? ($umum->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                        type="radio" name="umum" id="umum2" value="0" {{old('umum',
                                        optional($data->indikator)->umum) == 0 ? 'checked' : ''}}>
                                    <label class="form-check-label" for="umum2">
                                        Tidak
                                    </label>
                                </div>
