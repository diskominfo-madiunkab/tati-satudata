                        ...
                        <div class="tab-pane active" id="tab-draft">
                            ...
                            <form style="margin-bottom: 30px" id="berita-acara" target="_blank"
                                ...
                                <button type="button" class="btn btn-success"
                                    onclick="confirmBeritacara('berita-acara')"><i class="bi bi-download"></i> Unduh
                                    Berita Acara</button>
                            </form>
                            @elseif($draft >= 0)
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data, type, full, meta) {
                    ...
                    actionButtons += '<td>';
                    actionButtons += '<a href="/data_produsen/detail/'+ full.id +'" class="btn btn-sm btn-warning" style="color: white" data-bs-placement="bottom" title="Detail Data"><i class="bi bi-info-circle"></i></a>';
                    actionButtons += '</td>';
                    if (full.status_id == '3') {
                        actionButtons += '<td>';
                    ...
                    if (full.data_prioritas == null || full.data_prioritas == 0) {
                        ...
                        actionButtons += '<i style="color:orange" class="bi bi-star-fill"></i>';
                    }
                    actionButtons += '</td>';
                    ...
                    result.data.forEach(function(datas, i) {
                        ...
                        if (datas.user_id != '{{Auth::user()->id}}') {
                             tableRow +='<table>' +
                                '<tr>' +
                                    '<td>' +
                                        '<a href="{{ url('/data_produsen/detail') }}/' + datas.id + '" class="btn btn-sm btn-warning" style="color: white" data-bs-placement="bottom" title="Detail Data"><i class="bi bi-info-circle"></i></a>' +
                                        '</td>';
                                        if(status == 3){
                                            tableRow +='<td>' +
                                                '<a href="javascript:void(0)" class="btn btn-sm btn-success float-right" onclick="$(\'#menyetujui-data\').modal(\'show\');$(\'#id_sukses\').val(\''+ datas.id +'\')"><i class="bi bi-check-circle"></i></a>' +
                                                '</td>' +
                                                '<td>' +
                                                '<a href="javascript:void(0)" class="btn btn-sm btn-danger float-right" onclick="$(\'#verticalycentered-tolak\').modal(\'show\');$(\'#id_verticalycentered\').val(\''+ datas.id +'\')"><i class="bi bi-x-circle"></i></a>' +
                                                '</td>' +
                                                '<td>' +
                                                '<form action="{{ url('/data_produsen/edit/') }}/'+ datas.id +'">' +
