...
@section('content')
    ...
    <div class="pagetitle">
        <h1>Daftar Penyebarluasan Data</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Daftar Penyebarluasan Data</h5>

                        <ul class="nav nav-tabs nav-tabs-bordered d-flex text-center" role="tablist">
                            <li class="nav-item flex-fill" role="presentation">
                                <a href="/data_produsen/penyebarluasan"
                                    class="nav-link {{ isset($status) && $status == 'publikasi' ? 'active' : '' }}"
                                    id="verifikasi-tab"><i class="bi bi-send"></i> Siap Dipublikasi</a>
                            </li>

                            <li class="nav-item flex-fill" role="presentation">
                                <a href="/data_produsen/penyebarluasan/terpublikasi"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            <div class="row">
                                                ...
                                                @if (request()->is('data_produsen/penyebarluasan/terpublikasi') || request()->is('data_produsen/penyebarluasan'))
                                                    <div class="col-md-6">
...
@push('js')
    ...
    <script>
        ...
        var opd_id = '{{ Auth::user()->opd_id }}'; // Mengambil status dari suatu sumber
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(progress, type, full, meta) {
                            ...
                            buttonsHtml +=
                                '<a class="btn btn-outline-primary btn-sm" href="/data_produsen/detail-data/' +
                                full.id + '"><i class="bi bi-eye"></i>Detail Data</a>';
                            buttonsHtml += '</div>';
    ...
    <script>
        $(document).ready(function() {
            $('#btnFilter').click(function() {
                ...
                if (role == 'produsen') {
                    url = '{{ route('filter_publikasi_produsen') }}'
                    ...
                    success: function success(result) {
                        ...
                        result.data.forEach(function(datas, i) {
                            ...
                            var tableRow = '<tr>' +
                                ...
                                '<td>' + (new Date(datas.updated_at)).toLocaleString(
                                    'en-ID', {
                                ...
                                '<a class="btn btn-outline-primary btn-sm" href="/data_walidata/publikasi/' +
                                datas.id +
                                '/organisasi"><i class="bi bi-info-circle"></i> Publikasi</a>' +
                                '<a class="btn btn-outline-success btn-sm" href="/export/' +
                                datas.id + '"><i class="bi bi-file-zip"></i>Export</a>';
                            if (datas.status_id == STATUS_TERPUBLIKASI) {
                                ...
                                tableRow +=
                                    '<a class="btn btn-outline-primary btn-sm" href="/data_walidata/detail-data/' +
                                    datas.id +
                                    '"><i class="bi bi-eye"></i> Informasi Data</a>';
                            }
