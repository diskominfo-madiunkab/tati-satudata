...
<body>
    ...
    <tr>
      <td class="ratakanankiri">
        <p style="padding-left: 0px; padding-right: 0px;">Pada hari ini, {{ $today->dayName }} tanggal {{
          ...
          ucwords(\App\Util\Rupiah::terbilang($request_tahun ?? $tahun)) }} bertempat di Graha Eka Kapti Kabupaten
          Madiun telah diselenggarakan
          Rapat Penetapan Daftar Data Tahun {{$request_tahun ?? $tahun}} oleh Forum Satu Data Indonesia tingkat
          Kabupaten Madiun.
        </p>
  ...
  <table class="menyatakan">
    ...
    <tr>
      ...
      <td style="">
        <font width="100px"> Daftar Data {{$opd->nama_opd}} Tahun {{$request_tahun ?? $tahun}} memuat Data Statistik
          Sektoral.
        </font>
      </td>
    </tr>
    <tr>
      ...
      <td style="">
        <font width="100px"> {{$opd->nama_opd}} wajib menyediakan data sesuai Daftar Data yang disepakati bersama Forum
    ...
    <tr>
      ...
      <td style=";">
        <font width="100px"> Dalam rangka mencukupi Daftar Data sebagaimana dimaksud dalam Diktum KESATU,
          {{$opd->nama_opd}} wajib mengajukan rekomendasi kegiatan statistik dan memenuhi Prinsip SDI (Standar Data,
  ...
  {{-- <table style="width: 100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td align="center">
          <font size="3">
            @if (!empty($adminOPD->nama_penjabat) && !empty($adminOPD->nip_penjabat) &&
            !empty($adminOPD->pangkat_penjabat))
  ...
  <table class="tbl" style="margin-left:auto;margin-right:auto" cellpadding="10" border="1 solid" posisi="Relative">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ Carbon::parse($dt->jadwal_rilis)->format('d-m-Y') }}</td>
