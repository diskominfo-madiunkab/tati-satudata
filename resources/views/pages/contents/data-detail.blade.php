                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            @if ($data->status_id != \App\Models\Data::STATUS_SETUJU)
                                ...
                                @if (
                                    $data->status_id != \App\Models\Data::STATUS_SETUJU_STANDART_DATA &&
                                        $data->status_id != \App\Models\Data::STATUS_PENGAJUAN_STANDART_DATA)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="metadata" data-bs-toggle="tab"
                                            data-bs-target="#metadatatab" type="button" role="tab"
                                            aria-controls="profile"><i class="bi bi-medium"></i> Metadata
                                        </button>
                                    </li>

                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="berkas-tab" data-bs-toggle="tab"
                                            data-bs-target="#berkastab" type="button" role="tab"
                                            aria-controls="home"><i class="bi bi-files"></i> Berkas
                                        </button>
                                    </li>
                                @endif
                            @endif
