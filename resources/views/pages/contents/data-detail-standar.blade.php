            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="metadata" data-bs-toggle="tab" data-bs-target="#standartab"
                                type="button" role="tab" aria-controls="profile"><i class="bi bi-info-circle"></i>
                                Standar Data
                            </button>
                        </li>
                        @endif
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane" id="berkastab">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="grafik-tab" data-bs-toggle="tab"
                                        data-bs-target="#grafik" type="button" role="tab" aria-controls="grafik"
                            ...
                            <div class="tab-content pt-2" id="myTabContent">
                                <div class="tab-pane fade show active" id="table" role="tabpanel"
                                    ...
                                    <div class="col-lg-12">
                                        @if (auth()->user()->hasAnyRole('produsen') && ($data->status_id == 10 ||
                                        $data->status_id == 7))
                                        <div class="card">
                                            <div class="row">
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{ route('visual.data.store') }}" method="POST"
                                                        ...
                                                        @csrf
                                                        <input type="number" value="{{$data->id}}" name="id_data"
                                                            id="id_data" hidden>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-striped">
                                                            <thead>
                                                                <tr>
                                                                    @foreach ($headers->sortBy('urutan_menyamping') as
                                                                    $header)
                                                                    <th>{{ $header->header }}</th>
                                                                    @endforeach
                                                                    @if (auth()->user()->hasAnyRole('produsen'))
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    @foreach($headers->sortBy('urutan_menyamping')->values()
                                                                    as $header)
                                                                    @php
                                                                    // dd($rowIndex);
                                            ...
                                            <div class="card" style="margin-bottom: 55%">
                                                <div class="card-body">
                                                    <form id="grafikForm{{ $k }}"
                                                        ...
                                                        <label for="dropdown_axis_x_{{ $table['table']['id'] }}">Axis
                                                            X</label>
                                                        <select name="axis_x" id="dropdown_axis_x_{{ $k }}"
                                                            ...
                                                            @else --}}
                                                            <option value="{{ $header->id }}" @if($existingData->
                                                                isNotEmpty() &&
                                                                isset($existingData[$k]) &&
                                                                $existingData[$k]->axis_x == $header->id) selected
                                                                @endif>{{ $header->header }}
                                                            </option>
                                                            {{-- @endif --}}
                                                            @endforeach
                                                        ...
                                                        <label for="dropdown_axis_y_{{ $table['table']['id'] }}">Axis
                                                            Y</label>
                                                        <span
                                                        ...
                                                        <select name="axis_y" id="dropdown_axis_y_{{ $k }}"
                                                            ...
                                                            <option value="{{ $header->id }}" @if($existingData->
                                                                isNotEmpty() &&
                                                                isset($existingData[$k]) &&
                                                                $existingData[$k]->axis_y == $header->id) selected
                                                                @endif>{{ $header->header }}
                                                            </option>
                                                            {{-- @endif --}}
                                                            @endforeach
                                                        ...
                                                        <select name="kategori" id="dropdown_category_{{ $k }}"
                                                            ...
                                                            <option value="{{ $header->id }}" @if($existingData->
                                                                isNotEmpty() &&
                                                                isset($existingData[$k]) &&
                                                                $existingData[$k]->kategori == $header->id) selected
                                                                @endif>{{ $header->header
                                                                }}</option>
                                                            @endif
                                                            {{-- @endif --}}
                                                        ...
                                                        <br>
                                                        @if (auth()->user()->hasAnyRole('produsen') && ($data->status_id
                                                        == 10 ||
                                                        $data->status_id == 7))
                                                    ...
                                                    <table class="table table-stripped datatable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if (auth()->user()->hasAnyRole('produsen'))
                                                                <td><a href="javascript:void(0)"
                                                                        class="btn btn-outline-danger btn-sm" onclick='$("#modal-hapus").modal("show");
                        ...
                        <div class="tab-pane" id="standartab">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="kode" name="kode" class="form-control" placeholder="kode Standar Data"
                                        readonly>{{old('kode', optional($data->standar)->kode)}}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="konsep" name="konsep" class="form-control"
                                        ...
                                        readonly>{{old('konsep', optional($data->standar)->konsep)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="definisi" name="definisi" class="form-control"
                                        ...
                                        readonly>{{old('definisi', optional($data->standar)->definisi)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="klasifikasi" name="klasifikasi" class="form-control"
                                        ...
                                        readonly>{{old('klasifikasi', optional($data->standar)->klasifikasi)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="ukuran" name="ukuran" class="form-control"
                                        ...
                                        readonly>{{old('ukuran', optional($data->standar)->ukuran)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="satuan" name="satuan" class="form-control"
                                        ...
                                        readonly>{{old('satuan', optional($data->standar)->satuan)}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="metadatatab">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="definisi"
                                        ...
                                        readonly>{{old('definisi', optional($data->indikator)->definisi ?? optional($data->standar)->definisi)}}</textarea>
                                </div>
                            </div>
                            ...
                            @php
                            $isImage = optional($data->indikator)->metode &&
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="metode" id="metode" class="form-control"
                                        disabled>{{optional($data->indikator)->metode}}</textarea>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="klasifikasi_penyajian"
                                        ...
                                        style="height: 100px" spellcheck="false" placeholder="Klasifikasi Penyajian"
                                        readonly>{{old('klasifikasi_penyajian', optional($data->indikator)->klasifikasi_penyajian)}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check"><input class="form-check-input" type="radio" name="komposit"
                                            id="komposit1" value="1" {{old('komposit',
                                            optional($data->indikator)->komposit) == 1 ? 'checked' : ''}} disabled>
                                        <label class="form-check-label" for="gridRadios1"> Ya </label>
                                    </div>
                                    <div class="form-check"><input class="form-check-input" type="radio" name="komposit"
                                            id="komposit2" value="0" {{old('komposit',
                                            optional($data->indikator)->komposit) == 0 || empty(old('komposit',
                                        optional($data->indikator)->komposit)) ? 'checked' : ''}} disabled> <label
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="nama_indikator_pembangun"
                                            ...
                                            readonly>{{old('nama_indikator_pembangun', optional($data->indikator)->nama_indikator_pembangun)}}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="nama_variabel_pembangun"
                                            ...
                                            readonly>{{old('nama_variabel_pembangun', optional($data->indikator)->nama_variabel_pembangun)}}</textarea>
                                        <small class="text-muted">Daftar nama dipisah menggunakan enter.</small>
                                    </div>
                                </div>
                            </section>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select
                                        ...
                                        <option value="nasional" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'nasional' || empty(old('level_estimasi',
                                            optional($data->indikator)->level_estimasi)) ? 'selected' : ''}}>Nasional
                                        </option>
                                        <option value="provinsi" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'provinsi' ? 'selected' : ''}}>Provinsi
                                        </option>
                                        <option value="kabupaten" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'kabupaten' ? 'selected' :
                                            ''}}>Kabupaten/kota</option>
                                        <option value="perangkat_daerah" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'perangkat_daerah' ? 'selected' :
                                            ''}}>Perangkat Daerah</option>
                                        <option value="kecamatan" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'kecamatan' ? 'selected' : ''}}>Kecamatan
                                        </option>
                                        <option value="kelurahan" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'kelurahan' ? 'selected' :
                                            ''}}>Desa/Kelurahan</option>
                                        <option value="rt" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'rt' ? 'selected' : ''}}>Rumah Tangga
                                        </option>
                                        <option value="individu" {{old('level_estimasi', optional($data->
                                            indikator)->level_estimasi) == 'individu' ? 'selected' : ''}}>Individu
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="umum" id="umum1" value="1"
                                            {{old('umum', optional($data->indikator)->umum) == 1 || empty(old('umum',
                                        optional($data->indikator)->umum)) ? 'checked' : ''}} disabled>
                                        <label class="form-check-label" for="umum1">
                                            Ya
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="umum" id="umum2" value="0"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="konsep"
                                        ...
                                        readonly>{{old('konsep', optional($data->variabel)->konsep ?? optional($data->standar)->konsep)}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select
                                        ...
                                        <option value="integer" {{old('tipe_data', optional($data->variabel)->tipe_data)
                                            == 'integer' || empty(optional($data->variabel)->tipe_data) ? 'selected' :
                                            ''}} disabled>Integer</option>
                                        <option value="float" {{old('tipe_data', optional($data->variabel)->tipe_data)
                                            == 'float' ? 'selected' : ''}}>Float</option>
                                        <option value="char" {{old('tipe_data', optional($data->variabel)->tipe_data) ==
                                            'char' ? 'selected' : ''}}>Char</option>
                                        <option value="string" {{old('tipe_data', optional($data->variabel)->tipe_data)
                                            == 'string' ? 'selected' : ''}}>String</option>
                                        <option value="array" {{old('tipe_data', optional($data->variabel)->tipe_data)
                                            == 'array' ? 'selected' : ''}}>Array</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="klasifikasi_isian"
                                        ...
                                        readonly>{{old('klasifikasi_isian', optional($data->variabel)->klasifikasi_isian ?? optional($data->standar)->klasifikasi)}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="aturan_validasi"
                                        ...
                                        readonly>{{old('aturan_validasi', optional($data->variabel)->aturan_validasi)}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="kalimat_pertanyaan"
                                        ...
                                        style="height: 100px" spellcheck="false" placeholder="Kalimat Pertanyaan"
                                        readonly>{{old('kalimat_pertanyaan', optional($data->variabel)->kalimat_pertanyaan)}}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="umum" id="umum1" value="1"
                                            {{old('umum', optional($data->variabel)->umum) == 1 || empty(old('umum',
                                        optional($data->variabel)->umum)) ? 'checked' : ''}} disabled>
                                        <label class="form-check-label" for="umum1">
                                            Ya
                                        </label>
                                    </div>
