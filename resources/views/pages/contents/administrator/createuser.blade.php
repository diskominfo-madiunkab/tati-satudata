                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/user/store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control mb-2 @error('password') is-invalid @enderror" type="password"
                                        name="password" placeholder="Kata Sandi" id="password">
                            ...
                            <div class="row mb-3">
                                <label id="label-konfirmasi-password" class="col-sm-2 col-form-label">Konfirmasi Kata
                                    Sandi</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="role_id" name="role_id" class="form-select"
                                        ...
                                        @foreach ($role as $dt)
                                            <option value="{{ $dt->id }}" @selected(old('role_id') == $dt->id)>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="opd_id" name="opd_id" class="form-select"
                                        ...
                                        @foreach ($opd as $dt)
                                            <option value="{{ $dt->id }}" @selected(old('opd_id') == $dt->id)>
                                                {{ $dt->nama_opd }}</option>
                                        @endforeach
                                    </select>
                                </div>
