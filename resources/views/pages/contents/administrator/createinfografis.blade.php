...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Tambah Infografis</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Buat Infografis</h5>
                    ...
                    <form action="{{ route('infografis.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="title" value="{{ old('title') }}" placeholder="Masukkan Judul Infografis"
                                    required>
                        ...
                        <!-- ==== NEW: Tableau input (optional) - placed right below Title ==== -->
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="tableau" id="tableau" rows="3"
                                    ...
                                    placeholder="Masukkan isi tableau (opsional)">{{ old('tableau') }}</textarea>
                                ...
                                @enderror
                                <small class="form-text text-muted mt-1">Boleh kosong — digunakan untuk data tambahan berupa teks.</small>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="tinymce-editor form-control @error('content') is-invalid @enderror"
                                    name="content" rows="5" placeholder="Masukkan Konten Infografis"
