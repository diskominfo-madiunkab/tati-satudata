...
<div class="pagetitle">
    <h1>Edit Demografis</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
            <li class="breadcrumb-item">Daftar Demografis</li>
            <li class="breadcrumb-item active">Edit Demografis</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit Demografis</h5>
                    <p style="font-size: 12px"><span style="color:red">*</span> Wajib Terisi</p>

                    <!-- General Form Elements -->
                    <form action="{{route('data-demografis.update', ['data_demografi' => $data->id])}}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <p style="font-size: 12px">Lihat icon di sini <a
                                    href="https://fontawesome.com/v4/icons/">https://fontawesome.com/v4/icons/</a></p>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('narasi_data') is-invalid @enderror"
                                    name="narasi_data" value="{{ old('narasi_data', $data['narasi_data']) }}"
                                    placeholder="Narasi Data" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('jml_data') is-invalid @enderror"
                                    name="jml_data" value="{{ old('jml_data', $data['jml_data']) }}"
                                    placeholder="Jumlah Narasi Data" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('narasi_1') is-invalid @enderror"
                                    name="narasi_1" value="{{ old('narasi_1', $data['narasi_1']) }}"
                                    placeholder="Narasi Data 1">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('jml_narasi_1') is-invalid @enderror"
                                    name="jml_narasi_1" value="{{ old('jml_narasi_1', $data['jml_narasi_1']) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('narasi_2') is-invalid @enderror"
                                    name="narasi_2" value="{{ old('narasi_2', $data['narasi_2']) }}"
                                    placeholder="Narasi Data 2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('jml_narasi_2') is-invalid @enderror"
                                    name="jml_narasi_2" value="{{ old('jml_narasi_2', $data['jml_narasi_2']) }}"
