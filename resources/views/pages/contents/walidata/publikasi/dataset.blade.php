                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" id="org_id" name="org_id" disabled>
                                                <option value="-1"
                                                    {{ empty(optional($data->publikasi)->org_id) ? 'selected' : '' }}>
                                                    - Pilih Data -</option>
                                                @foreach ($orgs as $org)
                                                    <option value="{{ $org['id'] }}"
                                                        {{ old('org_id', optional($data->publikasi)->org_id) == $org['id'] ? 'selected' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="title" name="title" type="text" class="form-control"
                                                {{ $data->status_id == 9 ? 'disabled' : '' }} placeholder="Judul Dataset"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" name="visibility" id="visibility"
                                                ...
                                                <option value="0"
                                                    {{ old('visibility', optional($data->publikasi)->visibility) == 0 ? 'selected' : '' }}>
                                                    Private</option>
                                                <option value="1"
                                                    {{ old('visibility', optional($data->publikasi)->visibility) == 1 ? 'selected' : '' }}>
                                                    Publik</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="tags" name="tags"
                                                value=" {{ old('tags', optional($data->publikasi)->tags) }}"
                                                class="form-control" data-role="tagsinput" placeholder="Tambahkan Tag"
                                                @disabled($data->status_id != \App\Models\Data::STATUS_SIAP_PUBLIKASI)>
