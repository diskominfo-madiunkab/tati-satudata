                        ...
                        },
                        {
                            ...
                            "render": function(data, type, full, meta) {
                                ...
                                if (full.status_id == 12 || full.status_id == 13 || full.status_id ==
                                    ...
                                    statusTahapan += '<br>';
                                    statusTahapan +=
                                        '<span class="badge bg-secondary">2. Proses Standar Data</span>';
                                    ...
                                    statusTahapan += '<br>';
                                    statusTahapan +=
                                        '<span class="badge bg-primary">3. Pengumpulan Data</span>';
                                } else if (full.status_id == 6 | full.status_id == 7 | full.status_id ==
                                    8) {
                                    statusTahapan +=
                                        '<span class="badge bg-info">1. Perencanaan Data</span>';
                                    statusTahapan += '<br>';
                                    ...
                                    statusTahapan += '<br>';
                                    statusTahapan +=
                                        '<span class="badge bg-warning">4. Pemeriksaan Data</span>';
                                    ...
                                    statusTahapan += '<br>';
                                    statusTahapan +=
                                        '<span class="badge bg-success">5. Penyebarluasan Data</span>';
