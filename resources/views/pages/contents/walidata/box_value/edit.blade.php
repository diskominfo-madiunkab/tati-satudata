...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Edit Box Value</h5>
                    <p style="font-size: 12px"><span style="color:red">*</span> Wajib Terisi</p>

                    <!-- General Form Elements -->
                    <form action="{{route('box-value.update', ['box_value' => $data->id])}}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                    name="judul" value="{{ old('judul',$data['judul']) }}" placeholder="Judul" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('ringkasan_nilai') is-invalid @enderror"
                                    name="ringkasan_nilai" value="{{ old('ringkasan_nilai',$data['ringkasan_nilai']) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('satuan') is-invalid @enderror"
                                    name="satuan" value="{{ old('satuan',$data['satuan']) }}" placeholder="Satuan">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select name="data_id" id="data_id" class="form-select select2"
                                    ...
                                    @foreach( $dt as $op)
                                    <option value="{{ $op->id }}" {{ $data->data_id == $op->id ? 'selected' : '' }}>{{
                                        $op->nama_data }}</option>
                                    @endforeach
                                </select>
                                <!-- error message untuk title -->
