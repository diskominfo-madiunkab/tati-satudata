                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('simpan-indikator', $data->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="definisi"
                                        ...
                                        style="height: 100px" spellcheck="false" placeholder="Definisi" disabled>{{ old('definisi', optional($data->indikator)->definisi ?? optional($data->standar)->definisi) }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="interpretasi" name="interpretasi" type="text"
                                        ...
                                        style="height: 100px" spellcheck="false" placeholder="Interpretasi" disabled>{{ old('interpretasi', optional($data->indikator)->interpretasi) }}</textarea>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @else
                                        <textarea name="metode" id="metode"
                                            class="form-control {{ isset($metode) ? ($metode->accepted ? 'is-valid' : 'is-invalid') : '' }}" disabled>{{ optional($data->indikator)->metode }}</textarea>
                                    @endif
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="klasifikasi_penyajian"
                                        ...
                                        style="height: 100px" spellcheck="false" placeholder="Klasifikasi Penyajian" disabled>{{ old('klasifikasi_penyajian', optional($data->indikator)->klasifikasi_penyajian) }}</textarea>
                                    @if (isset($klasifikasi_penyajian) && !empty($klasifikasi_penyajian->comment))
                                        <p class="text-muted text-comment">Komentar: {{ $klasifikasi_penyajian->comment }}
                                        </p>
                                    @endif
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check">
                                        <input
                                            ...
                                            {{ old('komposit', optional($data->indikator)->komposit) == 0 || empty(old('komposit', optional($data->indikator)->komposit)) ? 'checked' : '' }}
                                            disabled>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @if (isset($nama_indikator_pembangun) && !empty($nama_indikator_pembangun->comment))
                                            <p class="text-muted text-comment">Komentar:
                                                {{ $nama_indikator_pembangun->comment }}</p>
                                            <hr>
                                        @endif
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        @if (isset($nama_variabel_pembangun) && !empty($nama_variabel_pembangun->comment))
                                            <p class="text-muted text-comment">Komentar:
                                                {{ $nama_variabel_pembangun->comment }}</p>
                                            <hr>
                                        @endif
                                        <small class="text-muted">Daftar nama dipisah menggunakan enter.</small>
                                    </div>
                                ...
                                <div class="col-sm-10">
                                    <select
                                        ...
                                        <option value="nasional"
                                            {{ old('level_estimasi', optional($data->indikator)->level_estimasi) == 'nasional' || empty(old('level_estimasi', optional($data->indikator)->level_estimasi)) ? 'selected' : '' }}>
                                            Nasional</option>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input
                                            ...
                                            {{ old('umum', optional($data->indikator)->umum) == 1 || empty(old('umum', optional($data->indikator)->umum)) ? 'checked' : '' }}
                                            disabled>
                            ...
                            <a {{-- href="{{auth()->user()->hasAnyRole('produsen') ? '/data_produsen/pengumpulan' : '/data_walidata/pengumpulan'}}"  --}} href="{{ url()->previous() }}" class="btn btn-outline-secondary"><i
