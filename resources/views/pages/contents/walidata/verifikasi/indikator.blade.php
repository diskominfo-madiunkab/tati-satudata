                            ...
                            <div class="row col-sm-8">
                                ...
                                <div class="col-sm-{{$isImage ? 4 : 8}}">
                                    <textarea name="metode" id="metode"
                                        ...
                                        style="height: 100px" spellcheck="false"
                                        placeholder="Metode / Rumus Perhitungan"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <textarea name="klasifikasi_penyajian" readonly
                                    ...
                                    style="height: 100px" spellcheck="false"
                                    placeholder="Klasifikasi Penyajian">{{old('klasifikasi_penyajian', optional($data->indikator)->klasifikasi_penyajian)}}</textarea>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="btn-group-sm">
                                    <button
                                        ...
                                        data-name="klasifikasi_penyajian">Setuju <i class="bi bi-check"></i></button>
                                    <button
                                ...
                                <div class="col-sm-2">
                                    <div class="btn-group-sm">
                                        ...
                                        <button
                                            ...
                                            data-name="nama_indikator_pembangun">Revisi <i class="bi bi-x"></i></button>
                                        {{-- <button class="btn btn-comment btn-sm btn-outline-primary"
                                ...
                                <div class="col-sm-2">
                                    <div class="btn-group-sm">
                                        ...
                                        <button
                                            ...
                                            data-name="nama_variabel_pembangun">Revisi <i class="bi bi-x"></i></button>
                                        {{-- <button class="btn btn-comment btn-sm btn-outline-primary"
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then((r) => {
                            ...
                            Swal.fire({
                                ...
                                preConfirm: (comment) => {
                                    return $.post('{{route('verifikasi.komentar', $data->id)}}', {field: $(this).data('name'), comment: comment, category: 'indikator'})
                                        .then(response => {
                                            if (!response.ok) {
