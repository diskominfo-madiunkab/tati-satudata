                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                                                    data-bs-target="#home{{$berkas['id']}}" type="button" role="tab"
                                                    aria-controls="home" aria-selected="true">Preview</button>
                                            </li>
                                            @if($existingData)
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                                                    data-bs-target="#profile{{$berkas['id']}}" type="button" role="tab"
                                                    aria-controls="profile" aria-selected="false">Grafik</button>
                                            </li>
                                            @endif
                                        </ul>
                                        ...
                                        <div class="tab-content pt-2" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade" id="profile{{$berkas['id']}}" role="tabpanel"
