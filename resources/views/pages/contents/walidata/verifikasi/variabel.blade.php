                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <textarea name="klasifikasi_isian"
                                    ...
                                    disabled>{{old('klasifikasi_isian', optional($data->variabel)->klasifikasi_isian ?? optional($data->standar)->klasifikasi)}}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <div class="btn-group-sm">
                                    <button
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <textarea name="aturan_validasi"
                                    ...
                                    disabled>{{old('aturan_validasi', optional($data->variabel)->aturan_validasi)}}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <div class="btn-group-sm">
                                    <button
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <textarea name="kalimat_pertanyaan"
                                    ...
                                    disabled>{{old('kalimat_pertanyaan', optional($data->variabel)->kalimat_pertanyaan)}}</textarea>
                            </div>
                            <div class="col-sm-2">
                                <div class="btn-group-sm">
                                    <button
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="umum" id="umum2" value="0"
                                        {{old('umum', optional($data->variabel)->umum) == 0 ? 'checked' : ''}} disabled>
                    ...
                    if (result.isConfirmed) {
                        ...
                        .then((r) => {
                            ...
                            Swal.fire({
                                ...
                                preConfirm: (comment) => {
                                    return $.post('{{route('verifikasi.komentar', $data->id)}}', {field: $(this).data('name'), comment: comment, category: 'variabel'})
                                        .then(response => {
                                            if (!response.ok) {
