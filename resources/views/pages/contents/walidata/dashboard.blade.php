                    ...
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>{{$dataPrioritas}} <span class="text-success small pt-1 fw-bold">Data</span>
                                    </h6>
            ...
            <div class="row">
                <div class="col">
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 16px">Pengunjung Harian</h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>{{$harian}}</h6>
                                    <span class="text-info small pt-1 fw-bold">Orang</span>
                ...
                <div class="col">
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 16px">Pengunjung Bulanan</h5>
                ...
                <div class="col">
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 16px">Pengunjung Tahunan</h5>
                ...
                <div class="col">
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="font-size: 16px">Total Pengunjung</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="activity">
                        ...
                        <div class="activity-item d-flex">
                            ...
                            <div class="activity-content"><small>{{$a->causer->name }} - {{$a->description}}</small>
                            </div>
                        </div>
                        @endforeach
                    </div>
