                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            action="/data_produsen/store" @endif
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="nama_data" name="nama_data" type="text"
                                            value="{{ $uraian_indikator }}" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <input id="is_from_walidata" name="is_from_walidata" type="hidden" value="1">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select id="sumber_data" style="width: 100%" name="sumber_data"
                                            ...
                                            @foreach ($sumber as $sd)
                                                <option value="{{ $sd->sumber_data }}"
                                                    {{ $sd->sumber_data == 'Data Provinsi' ? 'selected' : '' }}>
                                                    {{ $sd->sumber_data }}</option>
                                            @endforeach
