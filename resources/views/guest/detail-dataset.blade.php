                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: @if (!empty($dataset['organization']))
                                                            <a href="{{ $dataset['organization']['link'] }}">{{
                                                                $dataset['organization']['title'] }}</a>
                                                            @else
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <br>
                                                            <a href="{{ $resource['url_preview'] }}" target="_blank"> <i
                                                                    style="color: blue" class="fas fa-eye"></i>
                                                                Pratinjau</a>
                                                        </td>
                                                        <td>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="meta-tab" data-bs-toggle="tab" data-bs-target="#meta"
                                type="button" role="tab" aria-controls="meta" aria-selected="false">Metadata</button>
                        </li>
                        {{-- @if($tables) --}}
                        <li class="nav-item" role="presentation">
                                    ...
                                    <div class="row mb-3" style="padding-top:20px">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama_data" name="nama_data" type="text" class="form-control"
                                                value="{{$getmeta->nama_data}}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama_data" name="nama_data" type="text" class="form-control"
                                                value="{{$getmeta->jenis_data ?? '-' }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama_data" name="nama_data" type="text" class="form-control"
                                                value="{{$getmeta->opd->nama_opd ?? '-' }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama_data" name="nama_data" type="text" class="form-control"
                                                value="{{$getmeta->sumber_data ?? '-' }}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="data_prioritas"
                                                    id="data_prioritas1" value="1" {{ $getmeta->data_prioritas == 1 ?
                                                'checked' : '' }} disabled>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="data_prioritas"
                                                    id="data_prioritas0" value="0" {{ $getmeta->data_prioritas == 0 ?
                                                'checked' : '' }} disabled>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="kode" name="kode" class="form-control"
                                                ...
                                                readonly>{{old('kode', optional($getmeta->standar)->kode)}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="konsep" name="konsep" class="form-control"
                                                ...
                                                readonly>{{old('konsep', optional($getmeta->standar)->konsep)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="definisi" name="definisi" class="form-control"
                                                ...
                                                readonly>{{old('definisi', optional($getmeta->standar)->definisi)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="klasifikasi" name="klasifikasi" class="form-control"
                                                ...
                                                readonly>{{old('klasifikasi', optional($getmeta->standar)->klasifikasi)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="ukuran" name="ukuran" class="form-control"
                                                ...
                                                readonly>{{old('ukuran', optional($getmeta->standar)->ukuran)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id="satuan" name="satuan" class="form-control"
                                                ...
                                                readonly>{{old('satuan', optional($getmeta->standar)->satuan)}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="meta" role="tabpanel" aria-labelledby="meta-tab">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="definisi"
                                                ...
                                                style="height: 100px" spellcheck="false" placeholder="Definisi"
                                                readonly>{{old('definisi', optional($getmeta->indikator)->definisi ?? optional($getmeta->standar)->definisi)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    @php
                                    $isImage = optional($getmeta->indikator)->metode &&
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @else
                                            <textarea name="metode" id="metode" class="form-control"
                                                disabled>{{optional($getmeta->indikator)->metode}}</textarea>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="klasifikasi_penyajian"
                                                ...
                                                placeholder="Klasifikasi Penyajian"
                                                readonly>{{old('klasifikasi_penyajian', optional($getmeta->indikator)->klasifikasi_penyajian)}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                    name="komposit" id="komposit1" value="1" {{old('komposit',
                                                    optional($getmeta->indikator)->komposit) == 1 ? 'checked' : ''}}
                                                readonly>
                                                <label class="form-check-label" for="gridRadios1"> Ya </label>
                                            </div>
                                            <div class="form-check"><input class="form-check-input" type="radio"
                                                    name="komposit" id="komposit2" value="0" {{old('komposit',
                                                    optional($getmeta->indikator)->komposit) == 0 ||
                                                empty(old('komposit',
                                                optional($getmeta->indikator)->komposit)) ? 'checked' : ''}} readonly>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="nama_indikator_pembangun"
                                                    ...
                                                    style="height: 100px" spellcheck="false"
                                                    placeholder="Nama Indikator Pembangun"
                                                    readonly>{{old('nama_indikator_pembangun', optional($getmeta->indikator)->nama_indikator_pembangun)}}</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="nama_variabel_pembangun"
                                                    ...
                                                    style="height: 100px" spellcheck="false"
                                                    placeholder="Nama Variabel Pembangun"
                                                    readonly>{{old('nama_variabel_pembangun', optional($getmeta->indikator)->nama_variabel_pembangun)}}</textarea>
                                                <small class="text-muted">Daftar nama dipisah menggunakan enter.</small>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select
                                                ...
                                                <option value="nasional" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'nasional' || empty(old('level_estimasi',
                                                    optional($getmeta->indikator)->level_estimasi)) ? 'selected'
                                                    : ''}}>Nasional</option>
                                                <option value="provinsi" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'provinsi' ? 'selected' : ''}}>Provinsi</option>
                                                <option value="kabupaten" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'kabupaten' ? 'selected' : ''}}>Kabupaten/kota</option>
                                                <option value="perangkat_daerah" {{old('level_estimasi',
                                                    optional($getmeta->indikator)->level_estimasi) ==
                                                    'perangkat_daerah' ? 'selected' : ''}}>Perangkat Daerah</option>
                                                <option value="kecamatan" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'kecamatan' ? 'selected' : ''}}>Kecamatan</option>
                                                <option value="kelurahan" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'kelurahan' ? 'selected' : ''}}>Desa/Kelurahan</option>
                                                <option value="rt" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) == 'rt' ?
                                                    'selected' : ''}}>Rumah Tangga</option>
                                                <option value="individu" {{old('level_estimasi', optional($getmeta->
                                                    indikator)->level_estimasi) ==
                                                    'individu' ? 'selected' : ''}}>Individu</option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="umum" id="umum1"
                                                    value="1" {{old('umum', optional($getmeta->indikator)->umum) == 1 ||
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="umum" id="umum2"
                                                    value="0" {{old('umum', optional($getmeta->indikator)->umum) == 0 ?
                                                'checked' : ''}} disabled>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama" name="nama" type="text"
                                                class="form-control {{ isset($nama) ? ($nama->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                                placeholder="Nama Variabel" value="{{old('nama', $getmeta->nama_data)}}"
                                                readonly>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="alias" name="alias" type="text"
                                                ...
                                                placeholder="Alias"
                                                value="{{old('alias', optional($getmeta->variabel)->alias)}}" readonly>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="konsep"
                                                class="form-control {{ isset($konsep) ? ($konsep->accepted ? 'is-valid' : 'is-invalid') : '' }}"
                                                style="height: 100px" spellcheck="false" placeholder="Konsep"
                                                readonly>{{old('konsep', optional($getmeta->variabel)->konsep ?? optional($getmeta->standar)->konsep)}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select
                                                ...
                                                <option value="integer" {{old('tipe_data', optional($getmeta->
                                                    variabel)->tipe_data) == 'integer' ||
                                                    empty(optional($getmeta->variabel)->tipe_data) ? 'selected' : ''}}
                                                    disabled>Integer</option>
                                                <option value="float" {{old('tipe_data', optional($getmeta->
                                                    variabel)->tipe_data) == 'float' ? 'selected' :
                                                    ''}}>Float</option>
                                                <option value="char" {{old('tipe_data', optional($getmeta->
                                                    variabel)->tipe_data) == 'char' ? 'selected' :
                                                    ''}}>Char</option>
                                                <option value="string" {{old('tipe_data', optional($getmeta->
                                                    variabel)->tipe_data) == 'string' ? 'selected'
                                                    : ''}}>String</option>
                                                <option value="array" {{old('tipe_data', optional($getmeta->
                                                    variabel)->tipe_data) == 'array' ? 'selected' :
                                                    ''}}>Array</option>
                                            </select>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="klasifikasi_isian"
                                                ...
                                                style="height: 100px" spellcheck="false" placeholder="Klasifikasi Isian"
                                                readonly>{{old('klasifikasi_isian', optional($getmeta->variabel)->klasifikasi_isian ?? optional($getmeta->standar)->klasifikasi)}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="aturan_validasi"
                                                ...
                                                style="height: 100px" spellcheck="false" placeholder="Aturan Validasi"
                                                readonly>{{old('aturan_validasi', optional($getmeta->variabel)->aturan_validasi)}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="kalimat_pertanyaan"
                                                ...
                                                readonly>{{old('kalimat_pertanyaan', optional($getmeta->variabel)->kalimat_pertanyaan)}}</textarea>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="umum" id="umum1"
                                                    value="1" {{old('umum', optional($getmeta->variabel)->umum) == 1 ||
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="umum" id="umum2"
                                                    value="0" {{old('umum', optional($getmeta->variabel)->umum) == 0 ?
                                                'checked' : ''}} disabled>
                                                <label class="form-check-label" for="umum2">
                                                    Tidak
                                                </label>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($rows->values() as $rowIndex =>
                                                    $row)
                                                    <tr>
                                                        @foreach ($headers->sortBy('urutan_menyamping')->values() as
                                                        $header)
                                                        @php
                                                        // dd($rowIndex);
                                                        $cell = $row->firstWhere('id_header', $header->id);
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="card" style="margin-bottom: 5%; margin-top: 5%">
                                            <div class="card-header">Grafik Visualisasi {{ $table['table']['namatabel']
                                                }}</div>
                                            {{-- <div>
                                                    ...
                                                    <form id="grafikForm{{ $k }}"
                                                        ...
                                                        <div class="row">
                                                            <input type="text" name="id_data" id="id_data"
                                                                value="{{$table['table']['id_data']}}" hidden>
                                                            <input type="text" name="id_table" id="id_table"
                                                                value="{{$table['table']['id']}}" hidden>
                                                            <div class="col-md-12 col-sm-12 col-12">
                                                                <div class="form-group">
                                                                    <label for="dropdown_axis_x">Axis X</label>
                                                                    <select name="axis_x" id="dropdown_axis_x"
                                                                        class="form-control select-axis-x"
                                                                        aria-label="Default select example">
                                                                        <option value="0">-- Data Tunggal --</option>
                                                                        ...
                                                                        <option value="{{ $header->id }}"
                                                                            ...
                                                                            isset($existingData[$k]) &&
                                                                            $existingData[$k]->axis_x == $header->id)
                                                                            selected @endif>{{ $header->header }}
                                                                        </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-12">
                                                                <div class="form-group">
                                                                    <label for="dropdown_axis_y">Axis Y</label>
                                                                    <select name="axis_y" id="dropdown_axis_y"
                                                                        ...
                                                                        <option value="{{ $header->id }}"
                                                                            @if($existingData->isNotEmpty() &&
                                                                            isset($existingData[$k]) &&
                                                                            $existingData[$k]->axis_y == $header->id)
                                                                            selected @endif>{{ $header->header }}
                                                                        </option>
                                                                        @endforeach
                                                                    </select>
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-12">
                                                                <div class="form-group">
                                                                    <label for="dropdown_category">Kategori</label>
                                                                    <select name="kategori" id="dropdown_category"
                                                                        ...
                                                                        <option value="{{ $header->id }}"
                                                                            @if($existingData->isNotEmpty() &&
                                                                            isset($existingData[$k]) &&
                                                                            $existingData[$k]->kategori == $header->id)
                                                                            selected @endif>{{ $header->header
                                                                            }}</option>
                                                                        @endif
                                                                        @endforeach
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-12">
                                                                <button class="default-button" id="btn-submit{{ $k }}"
