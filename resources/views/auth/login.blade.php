...
<body>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="#" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">Dapur Data</span>
                                </a>
                            </div><!-- End Logo -->
                                    ...
                                    <form class="row g-3 needs-validation" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="col-12">
                                            <input class="form-check-input me-2" type="checkbox" value=""
                                                id="flexCheckDefault" name="flexCheckDefault" onclick="ubahPassword()">
                                            <label for="yourPassword" class="form-label">Lihat Password</label>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex mb-2">
                                                <img src="{{ captcha_src() }}" alt="Captcha" id="captcha-image">
                                                <button class="btn btn-sm btn-primary ms-2" id="reload-captcha">
    ...
    <script>
        ...
        document.getElementById("reload-captcha").addEventListener("click", function(event) {
            event.preventDefault();
            document.getElementById("captcha-image").src = "{{ captcha_src() }}?r=" + Math.random();
        });
    </script>
